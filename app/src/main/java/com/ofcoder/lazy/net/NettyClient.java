...
public class NettyClient {
    ...
    private NettyCallbackListener listener;//写的接口用来接收服务端返回的值
...
//                                ch.pipeline().addLast(new StringDecoder(CharsetUtil.UTF_8));//解码
                ...
                try {
                    ...
                    isConnect = false;
                    listener.onServiceStatusConnectChanged(ConnectStatusEnum.STATUS_CONNECT_CLOSED);
    ...
    public void setListener(NettyCallbackListener listener) {
